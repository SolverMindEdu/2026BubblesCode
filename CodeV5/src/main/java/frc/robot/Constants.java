...
public final class Constants {
    ...
    public static final class Shooter {
        ...
        // Demo mode: fixed shot values (also tunable live via SmartDashboard
        // under Demo/ShooterRPS and Demo/HoodDeg)
        public static final double DEFAULT_TARGET_RPS = 38.0;
        public static final double DEFAULT_HOOD_DEG = 30.0; // placeholder, tune at demo
