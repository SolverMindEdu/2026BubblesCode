...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private final TalonFX shooterLeft = new TalonFX(Constants.Shooter.LEFT_ID, "rio");
  private final TalonFX shooterMiddle = new TalonFX(Constants.Shooter.MIDDLE_ID, "rio");
  private final TalonFX shooterRight = new TalonFX(Constants.Shooter.RIGHT_ID, "rio");
