...
public class ShotCalculator extends SubsystemBase {
  ...
  static {
    ...
    shotFlywheelSpeedMap.put(5.2, 63.0);
    shotFlywheelSpeedMap.put(4.4, 61.0);
    shotFlywheelSpeedMap.put(4.2, 58.0);
    shotFlywheelSpeedMap.put(3.9, 57.5);
    shotFlywheelSpeedMap.put(3.5, 55.0);  
    shotFlywheelSpeedMap.put(3.2, 54.5);
    shotFlywheelSpeedMap.put(3.0, 54.0);
    shotFlywheelSpeedMap.put(2.8, 53.0);
    shotFlywheelSpeedMap.put(2.5, 52.5);
    shotFlywheelSpeedMap.put(2.2, 51.0);
    shotFlywheelSpeedMap.put(2.0, 47.5);
