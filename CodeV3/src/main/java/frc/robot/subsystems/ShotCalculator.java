...
public class ShotCalculator extends SubsystemBase {
  ...
  static {
    ...
    passingShotHoodAngleMap.put(5.0, Rotation2d.fromDegrees(23.0)); // distance, angle
    passingShotFlywheelSpeedMap.put(1.45, 25.0); //distance RPS
    passingShotFlywheelSpeedMap.put(5.0, 64.0); //distance RPS
    passingShotFlywheelSpeedMap.put(7.5, 74.0); //distance RPS
  ...
  static {
    ...
    // shotHoodAngleMap.put(1.9, Rotation2d.fromDegrees(3.0)); // distance, angle
    // shotHoodAngleMap.put(2.3, Rotation2d.fromDegrees(6.0)); // distance, angle
    // shotHoodAngleMap.put(2.6, Rotation2d.fromDegrees(10.0)); // distance, angle
    // shotHoodAngleMap.put(3.0, Rotation2d.fromDegrees(15)); // distance, angle
    // shotHoodAngleMap.put(3.4, Rotation2d.fromDegrees(21)); // distance, angle
    // shotHoodAngleMap.put(4.2, Rotation2d.fromDegrees(21.5)); // distance, angle
    // shotHoodAngleMap.put(4.5, Rotation2d.fromDegrees(23.0)); // distance, angle

    // shotFlywheelSpeedMap.put(1.9, 49.0); //distance RPS
    // shotFlywheelSpeedMap.put(2.3, 49.5); //distance RPS
    // shotFlywheelSpeedMap.put(2.6, 51.0); //distance RPS
    // shotFlywheelSpeedMap.put(3.0, 54.5); //distance RPS
    // shotFlywheelSpeedMap.put(3.4, 57.0); //distance RPS
    // shotFlywheelSpeedMap.put(4.2, 61.0); //distance RPS
    // shotFlywheelSpeedMap.put(4.5, 62.0); //distance RPS

    shotHoodAngleMap.put(1.9, Rotation2d.fromDegrees(3)); // distance, angle
    ...
    shotFlywheelSpeedMap.put(1.9, 49.5); //distance RPSde
    shotFlywheelSpeedMap.put(2.5, 52.5); //distance RPS
    shotFlywheelSpeedMap.put(3.0, 55.0); //distance RPS
    shotFlywheelSpeedMap.put(3.3, 57.0); //distance RPS
    shotFlywheelSpeedMap.put(3.5, 58.0); //distance RPS  
    shotFlywheelSpeedMap.put(3.9, 62.0); //distance RPS
    shotFlywheelSpeedMap.put(4.0, 63.0); //distance RPS
    shotFlywheelSpeedMap.put(4.2, 61.0); //distance RPS
    shotFlywheelSpeedMap.put(4.5, 62.0); //distance RPS

    timeOfFlightMap.put(1.5, 0.01); //distance,  time
  }
