...
//         shotHoodAngleMap.put(2.32, Rotation2d.fromDegrees(16)); // distance, angle
//         shotHoodAngleMap.put(1.8, Rotation2d.fromDegrees(12)); // distance, angle
//         shotHoodAngleMap.put(1.5, Rotation2d.fromDegrees(10)); // distance, angle
//         shotHoodAngleMap.put(3.08, Rotation2d.fromDegrees(22.5)); // distance, angle
//         shotHoodAngleMap.put(3.25, Rotation2d.fromDegrees(22.5)); // distance, angle

//         shotHoodAngleMap.put(3.56, Rotation2d.fromDegrees(25)); // distance, angle
//         shotHoodAngleMap.put(2.75, Rotation2d.fromDegrees(18.5)); // distance, angle





//         // shotFlywheelSpeedMap.put(3.0, 43.0); //distance RPS
//         // shotFlywheelSpeedMap.put(2.5, 40.0); //distance RPS
//         shotFlywheelSpeedMap.put(2.432, 60.0); //distance RPS
//         shotFlywheelSpeedMap.put(1.8, 60.0); //distance RPS
//         shotFlywheelSpeedMap.put(1.52, 60.0); //distance RPS
//         shotFlywheelSpeedMap.put(3.08, 60.0); //distance RPS
//         shotFlywheelSpeedMap.put(3.25, 60.0); //distance RPS

//         shotFlywheelSpeedMap.put(3.56, 65.0); //distance RPS
//         shotFlywheelSpeedMap.put(2.75, 60.0); //distance RPS
...
//             )
//         );
//         double shooterToTargetDistance = targetPose.getTranslation().getDistance(shooterPosition.getTranslation())+Constants.shooterConstants.hubOffset;
